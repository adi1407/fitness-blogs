...
export const LEGAL_OPERATOR = "fitlives";
export const LEGAL_OPERATOR_NOTE =
  "fitlives is an educational fitness knowledge platform operated from India as a sole-proprietor brand (no registered company name yet).";
